...
void IO_Servo_Outout() {
    ...
    if (MULTI1 == 1) {
        ...
        digitalWrite(SERVO1, CanIoRxData[0] != 0 ? HIGH : LOW);
    }
    ...
    if (MULTI2 == 1) {
        ...
        digitalWrite(SERVO2, CanIoRxData[1] != 0 ? HIGH : LOW);
    }
    ...
    if (MULTI3 == 1) {
        ...
        digitalWrite(SERVO3, CanIoRxData[2] != 0 ? HIGH : LOW);
    }
#else
    if (MULTI1 == 1) {
        ...
        digitalWrite(SERVO1, Rx_16Data[9] != 0 ? HIGH : LOW);
    }
    ...
    if (MULTI2 == 1) {
        ...
        digitalWrite(SERVO2, Rx_16Data[10] != 0 ? HIGH : LOW);
    }
    ...
    if (MULTI3 == 1) {
        ...
        digitalWrite(SERVO3, Rx_16Data[11] != 0 ? HIGH : LOW);
    }
#endif
}
